export const projects = [
  {
    ...
    description:
      "This is basically a Full Stack E-commerce Web application which helps you to make online shopping for your choice goods. It connects buyers with sellers online.",
  ...
  {
    title: "Menufud Application",
    description:
      "An Application used to help customers order their favourite meals and have them delivered in real-time.",
    image: "/images/menufud_image.png",
    tags: ["React.js", "Material-ui", "Firebase"],
    source: "https://github.com/AbaniwoM/Menufud-app",
    visit: "https://menufud-delivery-app.netlify.app/",
    id: 2,
  },
  {
    title: "REST API React Project",
    description:
      "This is basically a project which involves consuming the endpoints from an available API. It displays loading time with conditional-rendering and manages the contents of the API with React.js.",
  ...
  },
  {
    ...
    description:
      "Get your favourite  pasteries ready in time and make your order. This app was built with React.js.",
  ...
  },
  {
    title: "VetConsult",
    description:
      "I worked with a team which built the VetConsult web application. It is basically a site that bridges the gap between the veterinary doctors and pet owners.",
